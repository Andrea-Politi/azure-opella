...
resource "azurerm_network_security_group" "bastion" {
  ...
  # Inbound: Bastion host communication (data plane)
  security_rule {
  ...
  # Outbound: allow SSH/RDP to VNet (target VMs)
  security_rule {
  ...
  # Outbound: allow HTTPS to AzureCloud (control plane)
  security_rule {
  ...
  # Outbound: Bastion host communication (data plane)
  security_rule {
